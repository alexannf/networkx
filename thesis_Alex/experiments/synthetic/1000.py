...
if __name__ == '__main__':
    ...
    G_rem = setup_2("remove", edge_stream_add, "synthetic", "1000")
    ...
    puzis_state_of_the_art_remove(G_rem, edge_stream_rem, groups_rem, "facebook", "107", space=True)
    thesis_remove_gbc(G_rem, edge_stream_rem, groups_rem, "facebook", "107", space=True)
