...
def side_side_compare_kourtellis_bc(G, edge, operation):
    G_new = copy.deepcopy(G)
    if operation == "add":
        G_new.add_edge(edge[0], edge[1])
    else:
    ...
    for s in G_dyn:
        print("s = {}, bc = {}, {}, {}".format(s, bc1[s], bc2[s], bc3[s]))



def side_side_compare_kourtellis_D(G, edge, operation):
    G_new = copy.deepcopy(G)
    if operation == "add":
        G_new.add_edge(edge[0], edge[1])
    else:
    ...
    for s in G_dyn:
        print("\ns = {}, D1 = {}".format(s, dict(sorted(D1[s].items()))))
        print("s = {}, D2 = {}".format(s, dict(sorted(D2[s].items()))))
        print("s = {}, D3 = {}".format(s, dict(sorted(D3[s].items()))))


def side_side_compare_kourtellis_SP(G, edge, operation):
    G_new = copy.deepcopy(G)
    if operation == "add":
        G_new.add_edge(edge[0], edge[1])
    else:
    ...
    for s in G_dyn:
        print("\ns = {}, SP1 = {}".format(s, dict(sorted(SP1[s].items()))))
        print("s = {}, SP2 = {}".format(s, dict(sorted(SP2[s].items()))))
        print("s = {}, SP3 = {}".format(s, dict(sorted(SP3[s].items()))))


def side_side_compare_kourtellis_delta(G, edge, operation):
    G_new = copy.deepcopy(G)
    if operation == "add":
        G_new.add_edge(edge[0], edge[1])
    else:
    ...
    for s in G_dyn:
        print("\ns = {}, Delta1 = {}".format(s, dict(sorted(Delta1[s].items()))))
        print("s = {}, Delta2 = {}".format(s, dict(sorted(Delta2[s].items()))))
        print("s = {}, Delta3 = {}".format(s, dict(sorted(Delta3[s].items()))))
