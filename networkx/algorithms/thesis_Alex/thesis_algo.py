...
from networkx.algorithms.thesis_Alex.kourtellis import algorithm_1
...
def dynamic_group_betweenness(G, C, bc, D, sigma, Delta, edge, operation, normalized=True, endpoints=True):
